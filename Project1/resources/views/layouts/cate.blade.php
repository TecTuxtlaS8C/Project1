...
<div class="header"><nav class="navbar navbar-dark bg-dark" aria-label="First navbar example">
    ...
    <a class="navbar-brand" href="/supervisor">Tablero|admin</a>
      <!--<a class="navbar-brand" href="/Productos/create">Agregar</a>
      <a class="navbar-brand" href="/Productos">Productos</a>-->
      <a class="navbar-brand" href="/Categoriasadmin">Regresar</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExample01">
       <ul class="navbar-nav me-auto mb-2">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/Categoriasadmin">Categoria</a>
          </li>
          <li class="nav-item">
