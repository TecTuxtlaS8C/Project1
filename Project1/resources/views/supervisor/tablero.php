...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="/autenticar" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li><a href="/user"><i class="fa fa-address-card-o" aria-hidden="true"></i>Users</a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="/Categorias"><i class="fa fa-address-card-o" aria-hidden="true"></i>Category</a></li>
          </ul>
        </li>
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      <img src="https://adminlte.io/themes/AdminLTE/dist/img/user1-128x128.jpgAlexander Pierce</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; Aldair Cruz 2021-2024 <a href="https://adminlte.io"></a>.</strong> All rights
    reserved.
  </footer>
